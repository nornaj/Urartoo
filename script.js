...
(function () {
  ...
  const quotes = [
    ...
    { text: 'Զարդը ստացա փաթեթավորված՝ ձեռքի տակ տաք քարի ջերմությունը զգացվում էս։ Տարիներ անց չէի ստացել նման բան։', who: 'Ռուզանա Սարգսյան' },
    { text: 'Ամուսնացնելու տարելիցին պատրաստեցի փիրուզով վզնոց։ Քարը այնպիսին է՝ ինչպիսին է սպասում էի։', who: 'Լիլիթ Ազարյան' },
